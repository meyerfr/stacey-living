...
tenants = [
  ...
  {email_or_name: 'jn.f.mueller@gmail.com', room: "D09", move_in: Date.parse('01.09.2019'), move_out: Date.parse('28.02.2021')},
  {email_or_name: 'flgpc@hotmail.com', room: "D10", move_in: Date.parse('01.03.2020'), move_out: Date.parse('28.02.2021')},
  {email_or_name: 'dmoskalik@web.de', room: "D11", move_in: Date.parse('31.08.2019'), move_out: Date.parse('28.02.2021')},
  {email_or_name: 'christoph.haeberlin@gmail.com', room: 'D12', move_in: Date.parse('27.07.2019'), move_out: Date.parse('26.01.2021')},
  ...
  {email_or_name: 'joachim.bizot@outlook.fr', room: 'D20', move_in: Date.parse('07.01.2020'), move_out: Date.parse('06.07.2020')},
  {email_or_name: 'saraislac@gmail.com', room: 'DB01', move_in: Date.parse('29.02.2020'), move_out: Date.parse('29.11.2020')},
  {email_or_name: 'david.hoehl@aol.com', room: 'D21', move_in: Date.parse('04.11.2019'), move_out: Date.parse('30.06.2020')},
  {email_or_name: 'mesaee@gmail.com ', room: 'D22', move_in: Date.parse('18.04.2020'), move_out: Date.parse('18.07.2020')},
...
def find_users_by_email_or_name(email_or_name)
  User.select{|u| u.full_name == email_or_name || u.email == email_or_name}
end

def update_current_tenants(tenants_array)
  tenants_array.each do |booking_attributes|
    ...
    if booking
      ...
      NOT_FOUND_USERS << booking_attributes[:email_or_name]
    end
  end
end
...
#       object.photos.attach(io: file, filename: "#{object.name} #{idx+1}", content_type: 'image/jpg')
#       object.save
#     end
#   end
# end
