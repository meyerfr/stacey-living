...
bookings = [
	{ room: "D01", full_name: "Anna Weirauch", email: "team@stacey-living.de", move_in: Date.parse("01.10.2019"), move_out: Date.parse("31.03.2020") },
	...
	{ room: "D07", name: "Daniel Nicolae Obersterescu", email: "cristian.obersterescu@gmail.com / dani4793@yahoo.com", move_in: Date.parse("15.09.2020"), move_out: Date.parse("31.01.2021") },
	...
	{ room: "D17", name: "Philip Pineda", email: "pipopin@googlemail.com", move_in: Date.parse("22.08.2020"), move_out: Date.parse("30.11.2020") },
	...
	{ room: "D21", name: "Shubham Sharma"	, move_in: Date.parse("29.06.2020"), move_out: Date.parse("28.08.2020") },
	...
	{ room: "D35", name: "Alexandra Gedert", email: "gedertalex@gmail.com", move_in: Date.parse("06.01.2021"), move_out: Date.parse("14.04.2021") },
	...
	{ room: "DB02", name: "Maria de los Santos Fernandez Romero", move_in: Date.parse("09.03.2020"), move_out: Date.parse("08.06.2020") },
	...
	{ room: "DB03", name: "Diego Fernando Gomez", move_in: Date.parse("01.05.2020"), move_out: Date.parse("31.07.2020") },
	{ room: "DB03", name: "Philipp Kramberg", email: "philipp@kramberg.de", move_in: Date.parse("28.08.2020"), move_out: Date.parse("30.08.2021") },
	{ room: "DB04", name: "Amelie Hartig", move_in: Date.parse("29.02.2020"), move_out: Date.parse("30.05.2020") },
	...
	{ room: "EW05", name: "Katrin Klütsch / van Asten", email: "kat.vanasten@gmail.com", move_in: Date.parse("01.07.2020"), move_out: Date.parse("31.03.2021") },
...
# {:name=>"Marvin Wobbe", :email=>"marvin.wobbe@gmx.de"}
# {:name=>"Nicolae Puican", :email=>"n.a.puican@gmail.com"}
# {:name=>"Daniel Nicolae Obersterescu", :email=>"cristian.obersterescu@gmail.com / dani4793@yahoo.com"}
# {:name=>"Philip Pineda", :email=>"pipopin@googlemail.com"}
# {:name=>"Vanessa Elana Kröger", :email=>"Miss.Kroeger@web.de"}
# {:name=>"Pierre Guillaume", :email=>"pierre.g.27@live.fr"}
# {:name=>"Shubham Sharma", :email=>nil}
# {:name=>"Sina Schunk", :email=>"Sina.Schunk@jahr-tsv.de"}
# {:name=>"Johanna Launer", :email=>"JLauner@web.de"}
# {:name=>"Alexandra Gedert", :email=>"gedertalex@gmail.com"}
# {:name=>"Deniz Aksoy", :email=>"d.aksoy@gmx.net"}
# {:name=>"Maria de los Santos Fernandez Romero", :email=>nil}
# {:name=>"Diego Fernando Gomez", :email=>nil}
# {:name=>"Amelie Hartig", :email=>nil}
# {:name=>"Alvaro Sanz García Sintas", :email=>nil}
# {:name=>"Katrin Klütsch / van Asten", :email=>"kat.vanasten@gmail.com"}
