...
class ContractPdf extends Component {
    ...
    return(
      <View style={styles.signContractWrapper}>
        <View style={styles.signContractSection}>
          ...
          <Text style={styles.inputField}>{this.props.contract && `${this.props.contract.user.first_name} ${this.props.contract.user.last_name}`}</Text>
        </View>
        <View style={styles.signContractSection}>
  ...
  render() {
    ...
    let userAddress = (this.props.contract && this.props.contract.user.address) && this.props.contract.user.address
    userAddress =  userAddress && `${userAddress.street}, ${userAddress.city} ${userAddress.zip}, ${userAddress.country}`
    return(
        ...
        <Page size="A4" style={styles.body} wrap>
          ...
          <View style={styles.table}>
            ...
            <View style={styles.tableRow}>
              ...
              <View style={styles.tableColLarge}>
                <Text style={styles.tableCell}>895€</Text>
              </View>
              <View style={styles.tableCol}>
          ...
          {this.props.contract &&
            this.signContract({signature: this.props.contract.signature, signed_date: this.props.contract.signed_date})
          }
