...
class ContractForm extends Component {
	constructor(props){
      ...
      userForm: {
        street: (props.contract && props.contract.user.address) ? props.contract.user.address.street : '',
        zip: (props.contract && props.contract.user.address) ? props.contract.user.address.zip : '',
        city: (props.contract && props.contract.user.address) ? props.contract.user.address.city : '',
        country: (props.contract && props.contract.user.address) ? props.contract.user.address.country : ''
      },
      contractForm: {
  ...
  render () {
    ...
    // console.log(this.props.contract.user.address)
    return (
...
function mapDispatchToProps(dispatch) {
  return bindActionCreators({ createContract, updateContract, createUserAddress, updateUserAddress }, dispatch);
}
